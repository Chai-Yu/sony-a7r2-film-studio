...
- ファイル：`FilmStudio-0.2.2-alpha-movie.apk`（3,789,810 バイト）— 既定の `faithful` 処理
- SHA-256：`e03d9c1132e72c54c74dd829783b48c12ebb390e8feb904cb829d833a7ea68b9`
- **白点アンカー**版 `FilmStudio-0.2.2-alpha-movie-leica-anchor.apk`（3,790,920 バイト、SHA-256 `4bdcab263a7050d6f6c2bc1d1b5d6fcd3bdc5b7139832b01e292e802eb2254c3`）も同ページにあります。白を白のまま保ち、全体を暗くしません。**両版の違いはライカのトーン出力のみ**で、行列は共通です。
