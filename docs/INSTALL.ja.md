...
3. APK の SHA-256 を確認します（macOS は `shasum -a 256`、Linux は `sha256sum`、PowerShell は `Get-FileHash -Algorithm SHA256`）。値は `1270f7d9dbed2f3b5d82f6c0ce93d5844c512e7b00108eb1c5c8c20c3ec50199` です。確認できるのはファイルの一致で、許諾や互換性ではありません。
