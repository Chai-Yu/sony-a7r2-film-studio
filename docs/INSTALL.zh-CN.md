...
3. 核对 APK 的 SHA-256（macOS 用 `shasum -a 256`、Linux 用 `sha256sum`、PowerShell 用 `Get-FileHash -Algorithm SHA256`），应为 `c4df639f1f7250d302aac3f4ad617b61c484bc579da61422acde5585a7a57d94`。校验的是文件一致性，不是法律许可或兼容保证。
